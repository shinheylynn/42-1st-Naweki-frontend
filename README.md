...
[main page]
* 배너 이미지 또는 텍스트, 자세히 보기/구매하기 버튼 클릭 시 제품 목록 페이지 이동
* 카테고리 컴포넌트를 활용한 드롭다운 구현
* 추천 상품 리스트 캐러셀 구현
...
### 상세페이지(유진님)
![product detail](https://user-images.githubusercontent.com/97745006/220053257-ad2b3427-345a-4975-8df1-a00322ac1b43.gif)
